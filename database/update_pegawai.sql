-- Update struktur tabel pegawai yang sudah ada
-- File: update_pegawai.sql
...
ALTER TABLE pegawai DROP COLUMN IF EXISTS gaji_pokok;

-- Pastikan kolom yang diperlukan ada
ALTER TABLE pegawai MODIFY COLUMN nama_lengkap VARCHAR(100) NOT NULL;
ALTER TABLE pegawai MODIFY COLUMN departemen VARCHAR(100) NULL;
...
-- Insert beberapa data pegawai contoh (jika tabel kosong)
...
-- Tampilkan hasil
SELECT 'Struktur tabel pegawai berhasil diupdate' as status;
